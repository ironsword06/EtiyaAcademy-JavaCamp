...
public class Main {
    public static void main(String[] args) {
        ...
        Customer customer1 = new IndividualCustomer(1,"985632",
        		canal,
                "Ali Can", "Demirkılıç","666687");
        ...
        CommercialActivity commercialActivity = new CommercialActivity((IndividualCustomer) customer1,
